<footer>
    ...
    <div class="text-center bg-dark py-4">
      <small class="text-secondary">Copyright &copy; <script>document.write(new Date().getFullYear())</script>. Designed &amp; Developed by <a href="{{asset('https://themedv.com/')}}">Morshed</a></small class="text-secondary">
    </div>
  </footer>